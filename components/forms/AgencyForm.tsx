...
const AgencyForm: React.FC<AgencyFormProps> = ({ onClose }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            addRegistration({
                type: 'agency',
                name: finalFormData.authPersonName + ' (' + finalFormData.registeredName + ')',
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="email" name="email" required value={formData.email} onChange={handleInputChange} placeholder="agency@example.com" className={inputBaseStyle} />
                            </div>
                            <div>
