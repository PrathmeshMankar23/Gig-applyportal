...
interface FreelancerFormData {
    fullName: string; designation: string; email: string; phone: string; linkedinUrl: string; location: string;
    legalNamePan: string; personalPan: string;
    ...
    portfolioUrl: string; commercialBasis: string; baseRate: string; noticePeriod: string; availability: string;
...
const FreelancerForm: React.FC<FreelancerFormProps> = ({ onClose }) => {
    ...
    const [formData, setFormData] = useState<FreelancerFormData>({
        ...
        fullName: '', designation: '', email: '', phone: '', linkedinUrl: '', location: '',
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Just store the file name if a file is attached
            if (formData.portfolioFile) {
                finalFormData.portfolioUrl = formData.portfolioFile.name;
                finalFormData.portfolioPdfData = formData.portfolioPdfData;
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="email" name="email" required value={formData.email} onChange={handleInputChange} placeholder="you@example.com" className={inputBaseStyle} />
                            </div>
                            <div>
                                <label className={labelStyle}>Phone Number *</label>
                                <input type="tel" name="phone" required value={formData.phone} onChange={handleInputChange} placeholder="+1 234 567 890" className={inputBaseStyle} />
                            </div>
                            <div>
