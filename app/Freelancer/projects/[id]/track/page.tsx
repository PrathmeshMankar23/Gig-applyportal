...
export default function FreelancerProjectTrackingPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    return (
        <div className="space-y-6 relative">
            ...
            {/* Back Button */}
            <Link href="/Freelancer/active-projects" className="flex items-center gap-2 text-gray-500 hover:text-gray-900 transition-colors mb-4 w-fit">
